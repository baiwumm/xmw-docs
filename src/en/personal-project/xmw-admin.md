---
title: Background system based on React + Nest full stack development
---
...
::: warning
This project has completed the core functions of the normal background: permission design, dynamic menu, multi-language internationalization, user and role management.

This project is no longer maintained, if you need to learn or use, you can copy the source code to the local for expansion.
:::
